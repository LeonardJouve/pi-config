...
externally managed worktree), the agent leaves work uncommitted unless the
user explicitly approves one commit. Then inform the user about App controls:

- **"Create branch"** — names the branch, then offers commit/push/PR via App UI
